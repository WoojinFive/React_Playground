export default {
  ...
  projects: [
    ...
    },
    {
      ...
      fullDesc: [
        "The project was to renew the Arirang restaurant website. The most important goal was to create a homepage to improve the convenience of customers' access to the menu. Therefore, the design and developing focused on the convenience of access to the menu except for additional functions.",
        'HTML, CSS and JavaScript technologies were used to build the website, and Apache was used for the server.'
      ],
      date: 'May 2019',
    ...
    },
    {
      ...
      imageFull: [
        '/images/portfolio/07-full.jpg',
        '/images/portfolio/07-full-2.jpg'
      ],
