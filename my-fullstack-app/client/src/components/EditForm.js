...
class EditForm extends Component {
  ...
  componentDidMount() {
    const restObject = ({ _id, meetingHistory, registered, index, __v, ...rest }) => rest
    const clonedContact = restObject(this.props.location.state.contact)
    clonedContact.picture = `https://robohash.org/${clonedContact.name.first}?set=set2`;
  ...
  handleSubmit = (e) => {
    ...
    // Axios.put(`${process.env.REACT_APP_API_URI}/contacts/${this.props.match.params.index}`, this.state.contact)
    //   .then(res => {
    //     if(res.status === 200) {
    ...
    //       return this.props.history.push(referer ? referer : `/${this.props.match.params.index}`);
    //     }
    //   })
    //   .catch(error => {

    //   })
    HandleDB.edit(this.state.contact, this.props.match.params.index, (err, res) => {
      if(err) {
                    ...
                    <div className="row justify-content-md-around pb-5">
                        ...
                        <div className="row">
                          ...
                          <div className="col-md-8">
                            <div className="input-group input-group-sm mb-3">
                              <input type="text" className="form-control" value={this.state.contact.name.first?this.state.contact.name.first:''} name="first" onChange={this.handleNameChange}/>
                            </div>
                          </div>
                        </div>
                        <div className="row">
                          ...
                          <div className="col-md-8">
                            <div className="input-group input-group-sm mb-3">
                              <input type="text" className="form-control" value={this.state.contact.name.last?this.state.contact.name.last:''} name="last" onChange={this.handleNameChange}/>
                            </div>
                          </div>
                        </div>
                        <div className="row">
                          ...
                          <div className="col-md-8">
                            <div className="input-group input-group-sm mb-3">
                              <input type="text" className="form-control" value={this.state.contact.relationship?this.state.contact.relationship:''} name="relationship" onChange={this.handleChange}/>
                            </div>
                          </div>
                        </div>
                        <div className="row">
                          ...
                          <div className="col-md-8">
                            <div className="input-group input-group-sm mb-3">
                              <input type="text" className="form-control" value={this.state.contact.age?this.state.contact.age:''} name="age" onChange={this.handleChange}/>
                            </div>
                          </div>
                        </div>
                        <div className="row">
                          ...
                          <div className="col-md-8">
                            <div className="input-group input-group-sm mb-3">
                              <input type="text" className="form-control" value={this.state.contact.email?this.state.contact.email:''} name="email" onChange={this.handleChange}/>
                            </div>
                          </div>
                        </div>
                        <div className="row">
                          ...
                          <div className="col-md-8">
                            <div className="input-group input-group-sm mb-3">
                              <input type="text" className="form-control" value={this.state.contact.phone?this.state.contact.phone:''} name="phone" onChange={this.handleChange}/>
                            </div>
                          </div>
                        </div>
                      </div>  
                        ...
                        <div className="row">
                          <div className="col-md-6">
                            <div className="row">
                              ...
                              <div className="col-md-8">
                                <div className="input-group input-group-sm mb-3">
                                  <input type="text" className="form-control" value={this.state.contact.address.building?this.state.contact.address.building:''} name="building" onChange={this.handleAddressChange}/>
                                </div>
                              </div>
                            </div>
                          </div>
                          <div className="col-md-6">
                            <div className="row">
                              ...
                              <div className="col-md-8">
                                <div className="input-group input-group-sm mb-3">
                                  <input type="text" className="form-control" value={this.state.contact.address.street?this.state.contact.address.street:''} name="street" onChange={this.handleAddressChange}/>
                                </div>
                              </div>
                            </div>
                          </div>
                        ...
                        <div className="row">
                          <div className="col-md-6">
                            <div className="row">
                              ...
                              <div className="col-md-8">
                                <div className="input-group input-group-sm mb-3">
                                  <input type="text" className="form-control" value={this.state.contact.address.city?this.state.contact.address.city:''} name="city" onChange={this.handleAddressChange}/>
                                </div>
                              </div>
                            </div>
                          </div>
                          <div className="col-md-6">
                            <div className="row">
                              ...
                              <div className="col-md-8">
                                <div className="input-group input-group-sm mb-3">
                                  <input type="text" className="form-control" value={this.state.contact.address.state?this.state.contact.address.state:''} name="state" onChange={this.handleAddressChange}/>
                                </div>
                              </div>
                            </div>
                          </div>
                        ...
                        <div className="row">
                          <div className="col-md-6">
                            <div className="row">
                              ...
                              <div className="col-md-8">
                                <div className="input-group input-group-sm mb-3">
                                  <input type="text" className="form-control" value={this.state.contact.address.country?this.state.contact.address.country:''} name="country" onChange={this.handleAddressChange}/>
                                </div>
                              </div>
                            </div>
                          </div>
                          <div className="col-md-6">
                            <div className="row">
                              ...
                              <div className="col-md-8">
                                <div className="input-group input-group-sm mb-3">
                                  <input type="text" className="form-control" value={this.state.contact.address.zip?this.state.contact.address.zip:''} name="zip" onChange={this.handleAddressChange}/>
                                </div>
                              </div>
                            </div>
                          </div>
                      ...
                      <div className="col-md-10">
                        <div className="row">
                          ...
                          <div className="col-md-10">
                            <div className="input-group input-group-sm mb-3">
                              <input type="text" className="form-control" value={this.state.contact.picture?this.state.contact.picture:''} placeholder={this.state.contact.picture} name="picture" onChange={this.handleChange}/>
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="d-flex justify-content-center align-items-center">
                      <div className="btn">
                          ...
                          <button type="button" className="btn btn-sm btn-outline-secondary">
                            <Link 
                              to={this.props.location.state.referer ? this.props.location.state.referer : `/${this.props.match.params.index}`} 
